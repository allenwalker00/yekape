	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<!-- <a href="#">
					<img alt="Logo" src="{{asset('assets/fkunair.png')}}" height="50"/>
				</a> -->
			</div>
			...
			-->
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav aa">
								<li class="kt-menu__item " aria-haspopup="true">
									<a href="{{route('dashboard-link')}}" class="kt-menu__link ">
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
									<div class="kt-header__topbar-user">
										...
										<span class="kt-header__topbar-username kt-hidden-mobile">{{(Auth::check()) ? Auth::user()->nama : 'Guest'}}</span>
					...
					<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-footer__copyright">
								2019 &copy; Sistem Informasi & Manajemen Bisnis | CV. Sejati Mojokerto
							</div>
						</div>
					</div>
			...
			$(document).ready(function () {
				...
				$('.aa a').each(function () {
					if (this.href == path || path.indexOf(this.href) != -1) {
						...
						// $(this).parent().parent().parent().addClass('m-nav__item--active');
						// $(this).parent().parent().parent().parent().addClass('in');
						$(this).parent().parent().parent().parent().parent().parent().parent().addClass('kt-menu__item--open');
						$(this).parent().parent().parent().parent().addClass('kt-menu__item--open kt-menu__item--expanded');
					}
				});                               
			});
		</script>
